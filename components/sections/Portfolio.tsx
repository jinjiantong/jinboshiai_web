  ...
  return (
    <section id="portfolio" className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 pt-16">
      ...
      <div ref={observerRef}>
        ...
        {error && (
          <div className="min-h-screen flex items-center justify-center">
            <div className="text-center px-4 max-w-md">
              ...
              <p className="text-slate-600 text-sm sm:text-base mb-4">{error}</p>
              <button 
                onClick={handleRetry}
                className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-2.5 bg-orange-500 text-white rounded-full hover:bg-orange-600 transition-colors text-sm font-medium"
              >
        ...
        {hasLoaded && !loading && !error && portfolios.length > 0 && (
          <div 
