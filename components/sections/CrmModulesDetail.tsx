...
const moduleDetails = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: '主动赢单', desc: '商机确认成交后手动标记赢单，自动触发七章节复盘与成功因子提取' },
      { name: '主动丢单', desc: '商机确认流失后手动标记丢单，自动触发六章节复盘与失败原因分析' },
    ],
  },
  {
    no: '三',
  ...
  },
  {
    ...
    features: [
      ...
      { name: '丢单复盘', desc: '自动生成六章节复盘报告（含失败原因 + 改进建议）' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: '创建任务', desc: '支持每日策略大脑优化（每天 02:00：策略优化 + 赢/丢单因子打标 + 聚合 lift）、定时日报/周报/月报/日程' },
